...
// #ifndef MMTKHEAP
        ...
        newI = builder.CreateCall(poolAllocFunc, { ptls, pool_offs, pool_osize, target->getArgOperand(2) });
// #else
//         auto pool_offs = ConstantInt::get(Type::getInt32Ty(F.getContext()), offset);
//         auto pool_osize = ConstantInt::get(Type::getInt32Ty(F.getContext()), osize);
...
//         auto new_cursor = builder.CreateNSWAdd(result, ConstantInt::get(Type::getInt64Ty(target->getContext()), osize));
