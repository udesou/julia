...
Value *FinalLowerGC::lowerGCAllocBytes(CallInst *target, Function &F)
{
    ...
    if (offset < 0) {
...
#else
        int mmtk_osize = sz + sizeof(jl_taggedvalue_t);
        ...
        auto new_cursor = builder.CreateNSWAdd(result, ConstantInt::get(Type::getInt64Ty(target->getContext()), mmtk_osize + sizeof(jl_taggedvalue_t)));
        ...
        auto pool_osize = ConstantInt::get(Type::getInt32Ty(F.getContext()), mmtk_osize);
        ...
        auto object_size = ConstantInt::get(Type::getInt64Ty(target->getContext()), mmtk_osize+sizeof(jl_taggedvalue_t));
