    ...
    if (auto CI = dyn_cast<ConstantInt>(target->getArgOperand(1))) {
        ...
        if (offset >= 0) {
            ...
            if (INLINE_FASTPATH_ALLOCATION) {
                ...
                auto cursor_ptr = builder.CreateInBoundsGEP(Type::getInt64Ty(target->getContext()), ptls, cursor_pos);
                ...
                auto limit_ptr = builder.CreateInBoundsGEP(Type::getInt64Ty(target->getContext()), ptls, limit_pos);
                ...
                auto pool_alloc_tls = builder.CreateInBoundsGEP(Type::getInt64Ty(target->getContext()), ptls, pool_alloc_pos);
